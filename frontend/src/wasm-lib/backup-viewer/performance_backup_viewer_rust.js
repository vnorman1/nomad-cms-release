 ...
 * @returns {Uint8Array}
 */
export function decrypt_backup(file_data, private_key_pem) {
    ...
    const ret = wasm.decrypt_backup(ptr0, len0, ptr1, len1);
    if (ret[3]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('performance_backup_viewer_rust_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
